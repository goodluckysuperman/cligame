...
SENIOR_MESSAGES = {
    0: "先别急着把自己当成英雄。先确认事故总览。只有知道今夜到底坏了什么，你才配决定该修哪一处。",
    1: "很好。现在去看模块状态。记住，离线不一定代表损坏，有些切断本身就是收容。",
    2: "去档案区。先读事故摘要，不要一上来就翻日志。你需要先知道系统自己承认了什么。",
    3: "现在看看你是谁。然后立刻留下第一份快照。今夜最先坏掉的不是机器，是信息本身。",
    4: "远程支援马上会出现。从那一刻开始，不会再有人替你保证哪句话是真的。",
    5: "恢复模块不是修系统，是在拿风险换信息。每往前一步，事故和你自己的身份都会一起变化。",
    6: "现在已经不只是调查了。你在靠近协议，也在靠近某种被写好的归宿。",
    7: "协议不是菜单。它们只是系统为不同牺牲准备好的名字。你现在要做的，是决定自己愿意被写成哪一种。",
    8: "最后一步里，没有谁还能替你承担代价。包括我。"
}
